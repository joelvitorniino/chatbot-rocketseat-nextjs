          ...
          <div className="bg-white shadow-md rounded-md p-6 space-y-4">
            <div>
              ...
              <div className="text-right">
                <Link
                  href="http://chatbot-rocketseat-api-production.up.railway.app/auth/google/callback"
              ...
              <div>
                <button
                  className="w-full text-sm bg-blue-500 hover:bg-blue-600 dark:bg-gray-800 dark:hover:bg-gray-900 px-6 py-1 mt-3 rounded text-white shadow"
                  onClick={login}
                >
                  Login
                </button>
